...
const mockEvents: Event[] = [
  ...
  },
  {
    ...
    description:
      'Connect with industry leaders and learn about the latest business trends.',
    date: '2025-08-12',
  ...
  },
  {
    ...
    totalTickets: 100,
    imageUrl:
      'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&q=80&w=1740',
  },
];
      ...
      <div className='flex flex-col sm:flex-row justify-between gap-4'>
        <div className='flex space-x-2'>
          ...
          <Button
            ...
            className={
              filter === 'upcoming' ? 'bg-primary hover:bg-primary/90' : ''
            }
          ...
          <Button
            ...
            className={
              filter === 'past' ? 'bg-primary hover:bg-primary/90' : ''
            }
