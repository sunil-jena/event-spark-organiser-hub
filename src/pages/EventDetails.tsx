...
const EventDetails = () => {
  ...
  const soldPercentage = Math.round(
    (mockEvent.ticketsSold / mockEvent.totalTickets) * 100
  );
  const daysLeft = Math.round(
    (new Date(mockEvent.date).getTime() - new Date().getTime()) /
      (1000 * 60 * 60 * 24)
  );
            ...
            <CardContent className='pt-6'>
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <span>
                    {mockEvent.ticketsSold} / {mockEvent.totalTickets}
                  </span>
                </div>
                <div className='flex justify-between items-center'>
                  <span className='text-sm text-gray-500'>Revenue:</span>
                  <span className='font-bold'>
                    ${mockEvent.revenue.toLocaleString()}
                  </span>
                </div>
        ...
        <TabsContent value='overview' className='space-y-6'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            ...
            <div className='space-y-6'>
              <OrderStatistics
                title='Order Status'
                totalOrders={mockEvent.orderStats.reduce(
                      ...
                      return (
                        <div key={type.name} className='space-y-2'>
                          ...
                          <div className='flex justify-between items-center text-sm'>
                            ...
                            <span className='text-gray-500'>
                              Revenue: $
                              {(type.sold * type.price).toLocaleString()}
                            </span>
                          </div>
                          <div className='w-full bg-gray-200 rounded-full h-2'>
                            <div
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Breakdown of ticket sales by promotional channel
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='h-64'>
                    ...
                    <PieChart>
                      <Pie
                        data={[
                          {
                            name: 'Social Media',
                            value: mockEvent.promotionStats.socialMedia,
                          },
                          {
                            name: 'Email Campaign',
                            value: mockEvent.promotionStats.emailCampaign,
                          },
                          {
                            name: 'Partnerships',
                            value: mockEvent.promotionStats.partnerships,
                          },
                          {
                            name: 'Direct',
                            value: mockEvent.promotionStats.direct,
                          },
                        ]}
                        cx='50%'
                        cy='50%'
        ...
        <TabsContent value='orders' className='space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete list of orders for this event
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='rounded-md border'>
                <Table>
                  ...
                  <TableBody>
                    {mockEvent.recentOrders
                      .concat(mockEvent.recentOrders)
                      .map((order, index) => (
                        <TableRow key={index}>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            <Card className='lg:col-span-2'>
              <CardHeader>
                ...
                <CardDescription>
                  Projected ticket sales until event date
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='h-80'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Financial projections for this event
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-6'>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <span className='font-bold'>
                      ${(mockEvent.revenue * 1.2).toLocaleString()}
                    </span>
                  </div>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <span className='font-bold'>
                      ${(mockEvent.revenue * 1.5).toLocaleString()}
                    </span>
                  </div>
                  ...
                  <div className='pt-4'>
                    <div className='flex justify-between text-sm'>
                      ...
                      <span className='font-medium'>
                        {Math.round(
                          (mockEvent.revenue / (mockEvent.revenue * 1.5)) * 100
                        )}
                        %
                      </span>
                    </div>
                    <div className='w-full bg-gray-200 rounded-full h-2 mt-2'>
                      <div
                        className='bg-primary h-2 rounded-full'
                        style={{
                          width: `${Math.round((mockEvent.revenue / (mockEvent.revenue * 1.5)) * 100)}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className='bg-gray-50 p-4 rounded-lg mt-6'>
                    ...
                    <ul className='space-y-2 text-sm'>
                      ...
                      <li className='flex items-start gap-2'>
                        <span className='text-primary'>•</span>
                        <span>
                          Offer early bird discounts for the remaining tickets
                        </span>
                      </li>
                    </ul>
                  </div>
