    ...
    <div className="space-y-6 max-w-7xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="font-medium text-amber-800">Payout Schedule</p>
                    <p className="text-amber-700 mt-1">
                      Payouts are processed 7 days after the event to allow for any refunds or disputes.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>List of all your payouts and their status</CardDescription>
            </div>
                          ...
                          <TableCell colSpan={6} className="p-0">
                            <div className="bg-gray-50 p-4">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                  ...
                                  <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                      ...
                                      <span>${payout.revenue.toLocaleString()}</span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span className="text-gray-500">Service Fee:</span>
                                      <span>-${payout.serviceFee.toLocaleString()}</span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span className="text-gray-500">Payment Processing Fee:</span>
                                      <span>-${payout.paymentFee.toLocaleString()}</span>
                                    </div>
                                ...
                                <div>
                                  <h4 className="font-medium mb-2">Transferred To</h4>
                                  <div className="space-y-2 text-sm">
                                    <div className="flex justify-between">
                                      <span className="text-gray-500">Account Name:</span>
                                      <span>{payout.bankDetails.accountName}</span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span className="text-gray-500">Account Number:</span>
                                      <span>{payout.bankDetails.accountNumber}</span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span className="text-gray-500">Bank Name:</span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Answers to common questions about the payout process</CardDescription>
        </CardHeader>
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                Payouts are typically processed 7 days after your event has concluded. This waiting period allows for any potential refunds or disputes to be processed before the final payout is calculated.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>What fees are deducted from my payout?</AccordionTrigger>
              <AccordionContent>
                The platform deducts a service fee of 8% from your total ticket revenue. Additionally, a payment processing fee of 2% is applied to cover transaction costs.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger>How can I update my banking information?</AccordionTrigger>
              <AccordionContent>
                You can update your banking information in the Payment Settings section. Please note that changes to banking details may require verification and can take 2-3 business days to process.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger>What if there's an issue with my payout?</AccordionTrigger>
              <AccordionContent>
                If you notice any discrepancies or issues with your payout, please contact our support team immediately with your payout ID and details of the issue. Our team will investigate and resolve the matter within 48 hours.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </CardContent>
