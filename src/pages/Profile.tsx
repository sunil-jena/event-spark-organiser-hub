...
import { Camera, Upload, User, Briefcase, IndianRupee, MapPin, Mail, Phone } from 'lucide-react';
...
const Profile = () => {
  ...
  const [formData, setFormData] = useState<ProfileFormData>({
    ...
    description: 'We organize innovative events that connect people and create memorable experiences.',
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <Card className="mb-6">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div>
            ...
            <CardDescription>Your profile image that will be visible to customers</CardDescription>
          </div>
        </CardHeader>
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardFooter>
            <Button className="bg-primary hover:bg-primary/90" onClick={() => handleSave("Personal Information")}>
              Save Changes
            </Button>
          </CardFooter>
        </Card>
        ...
        <Card>
          ...
          <CardFooter>
            <Button className="bg-primary hover:bg-primary/90" onClick={() => handleSave("Organization Details")}>
              Save Changes
            </Button>
          </CardFooter>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <Label className="text-sm font-medium mb-1 block" htmlFor="address">Street Address</Label>
              <Input 
                id="address"
                name="address"
                type="text" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <Label className="text-sm font-medium mb-1 block" htmlFor="state">State</Label>
                <Input 
                  id="state"
                  name="state"
                  type="text" 
              ...
              <div>
                <Label className="text-sm font-medium mb-1 block" htmlFor="postalCode">Postal Code</Label>
                <Input 
                  id="postalCode"
                  name="postalCode"
                  type="text" 
          ...
          <CardFooter>
            <Button className="bg-primary hover:bg-primary/90" onClick={() => handleSave("Address Information")}>
              Save Changes
            </Button>
          </CardFooter>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label className="text-sm font-medium mb-1 block" htmlFor="taxId">GST/PAN Number</Label>
              <Input 
                id="taxId"
                name="taxId"
                type="text" 
          ...
          <CardFooter>
            <Button className="bg-primary hover:bg-primary/90" onClick={() => handleSave("Billing Information")}>
              Save Changes
            </Button>
          </CardFooter>
        </Card>
