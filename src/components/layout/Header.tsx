...
import { Menu, Bell, Search, User, Calendar, X, IndianRupee } from 'lucide-react';
  ...
  return (
    <header className="h-16 border-b bg-white dark:bg-gray-900 flex items-center justify-between px-4 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="ghost" size="icon" className="relative md:hidden" onClick={toggleSearch}>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="font-medium text-sm hidden sm:block mr-1">Rohit Sharma</span>
          </Button>
        </div>
      </div>
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-3">
                  <div className="flex gap-3 p-2 hover:bg-gray-50 rounded-md cursor-pointer">
                    ...
                    <div>
                      <p className="font-medium text-sm">Summer Music Festival</p>
                      <p className="text-xs text-gray-500">10:00 AM - 08:00 PM</p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-2 hover:bg-gray-50 rounded-md cursor-pointer">
                    <div className="w-10 h-10 bg-primary/10 text-primary flex flex-col items-center justify-center rounded-md">
                    ...
                    <div>
                      <p className="font-medium text-sm">Tech Conference 2025</p>
                  ...
                  <div className="flex gap-3 p-2 hover:bg-gray-50 rounded-md cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">11:00 AM - 07:00 PM</p>
                    </div>
                  </div>
                </div>
                <Button variant="outline" className="w-full mt-3 text-sm h-8">View All Events</Button>
              </CardContent>
            </Card>
          </motion.div>
        )}
          ...
          >
            <Card className="w-80 shadow-lg">
              <CardContent className="p-4">
                ...
                <div className="space-y-3">
                  <div className="flex gap-3 p-2 hover:bg-gray-50 rounded-md cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">₹12,500 from Tech Conference</p>
                  ...
                  <div className="flex gap-3 p-2 hover:bg-gray-50 rounded-md cursor-pointer">
                    ...
                    <div>
                      <p className="font-medium text-sm">New booking confirmed</p>
                      <p className="text-xs text-gray-500">5 tickets for Summer Music Festival</p>
                ...
                <Button variant="outline" className="w-full mt-3 text-sm h-8">View All Notifications</Button>
              </CardContent>
            </Card>
          </motion.div>
        )}
