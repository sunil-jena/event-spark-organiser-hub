        ...
        searchBox.addListener('places_changed', () => {
          ...
          if (selectedCity) {
            ...
            if (cityComponent) {
              ...
              if (
                selectedCityObj &&
                !placeCity.includes(selectedCityObj.label.toLowerCase())
              ) {
                toast({
                  title: 'City Mismatch',
                  description:
                    'The selected location does not match the chosen city.',
                  variant: 'destructive',
                });
                return;
              }
  ...
  return (
    <Card>
      <CardContent className='pt-6'>
        ...
        <Tabs
          defaultValue='manual'
          onValueChange={(value) => setAddMethod(value as 'manual' | 'map')}
        >
                ...
                <div className='flex items-center space-x-2'>
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      venueFormik.setFieldValue('tba', checked)
                    }
                    ...
                    <PopoverTrigger asChild>
                      ...
                      >
                        {venueFormik.values.city
                          ? CITIES.find(
                              (city) => city.value === venueFormik.values.city
                            )?.label || venueFormik.values.city
                          : 'Select city'}
                  ...
                  <>
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        className={
                          venueFormik.errors.address &&
                          venueFormik.touched.address
                            ? 'border-red-500'
                            : ''
                        }
                      />
                    ...
                    <div className='space-y-2'>
                      ...
                      />
                      {venueFormik.errors.state &&
                        venueFormik.touched.state && (
                          <p className='text-red-500 text-sm'>
                            {venueFormik.errors.state}
                          </p>
                        )}
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        className={
                          venueFormik.errors.zipCode &&
                          venueFormik.touched.zipCode
                            ? 'border-red-500'
                            : ''
                        }
                      />
                ...
                <div className='grid gap-4 sm:grid-cols-2 mt-4'>
                  <div className='space-y-2'>
                    ...
                    <Input
                      ...
                      className={
                        venueFormik.errors.latitude &&
                        venueFormik.touched.latitude
                          ? 'border-red-500'
                          : ''
                      }
                    />
                  ...
                  <div className='space-y-2'>
                    ...
                    <Input
                      ...
                      className={
                        venueFormik.errors.longitude &&
                        venueFormik.touched.longitude
                          ? 'border-red-500'
                          : ''
                      }
                    />
          ...
          <TabsContent value='map' className='border rounded-lg p-4 bg-gray-50'>
            ...
            <div className='mb-4'>
              <Label htmlFor='venue-city-filter' className='mb-1 block'>
                Filter By City
              </Label>
              <Popover open={cityOpen} onOpenChange={setCityOpen}>
                <PopoverTrigger asChild>
              ...
              <form onSubmit={venueFormik.handleSubmit}>
                <div className='space-y-4'>
                  ...
                  <Button
                    ...
                    variant='secondary'
                    disabled={
                      !venueFormik.values.name || !venueFormik.values.city
                    }
                  >
                    <Plus className='h-4 w-4 mr-2' />{' '}
                    {editingVenueId
                ...
                >
                  <div>
                    ...
                    {venue.latitude && venue.longitude && (
                      <p className='text-xs text-gray-500'>
                        Location: {venue.latitude.toFixed(6)},{' '}
