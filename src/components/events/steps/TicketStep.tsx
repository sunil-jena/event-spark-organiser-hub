...
const TicketStep: React.FC<TicketConfiguratorProps> = ({
  ...
  const [ticketList, setTicketList] = useState<TicketFormValues[]>(
    ticketTypes || []
  );
  ...
  const formik = useFormik<TicketFormValues>({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      updatedValues.description = descriptionItems.filter(
        (item) => item.trim() !== ''
      );
        ...
        <CardContent className='pt-6'>
          ...
          >
            ...
            <div className='grid gap-6 sm:grid-cols-2'>
              ...
              <div className='space-y-2'>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    formik.setFieldValue('ticketCategory', value)
                  }
                >
                  <SelectTrigger
                    id='ticketCategory'
              ...
              <div className='space-y-2'>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    formik.setFieldValue('ticketStatus', value)
                  }
                >
                  <SelectTrigger
                    id='ticketStatus'
              ...
              {/* <div className='space-y-2 sm:col-span-2 bg-blue-50 p-4 rounded-md shadow-inner hover:bg-blue-100 transition-colors duration-300'>
                <div className='flex items-center justify-between'>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className='bg-white p-3 shadow-lg'>
                          <p className='max-w-xs'>
                            Combo tickets bundle multiple events or experiences
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      formik.setFieldValue('isCombo', checked)
                    }
                ...
                {formik.values.isCombo && (
                  <p className='text-xs text-blue-700 mt-2 bg-blue-100 p-3 rounded border-l-2 border-blue-500 animate-fade-in'>
                    This ticket will be sold as a combo package. Make sure to
                    correctly configure which dates, venues and time slots this
                    applies to.
                  </p>
                )}
              </div> */}
            ...
            <div className='mt-6 flex justify-end space-x-2'>
              ...
              <Button
                type='submit'
                className='bg-primary hover:bg-primary/90 flex items-center hover:shadow-md transition-all'
              >
                {isEditMode ? (
                  <>
              ...
              {ticketList.length > 0 ? (
                ...
                <div className='py-16 text-center text-muted-foreground'>
                  <div className='flex flex-col items-center justify-center space-y-4'>
                    <Tag
                      className='h-16 w-16 text-gray-300 animate-pulse'
                      strokeWidth={1.5}
                    />
                    <div className='space-y-2'>
                    ...
                    >
                      <PlusCircle className='mr-2 h-4 w-4' /> Start Adding
                      Tickets
                    </Button>
                  </div>
                </div>
              ...
              onClick={() => {
                if (ticketList.length === 0) {
                  toast({
                    ...
                    description:
                      'Please add at least one ticket for your event.',
                    variant: 'destructive',
                  });
                  return;
                }
