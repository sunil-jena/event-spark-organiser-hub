              ...
              {expanded[ticket.id] && (
                <div className='p-4 space-y-4 border-t'>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                      <Label htmlFor={`ticket-type-${ticket.id}`}>
                        Ticket Type
                      </Label>
                      <Select
                        value={ticket.type}
                  ...
                  <div>
                    <Label htmlFor={`ticket-desc-${ticket.id}`}>
                      Description
                    </Label>
                    <Textarea
                  ...
                  <div>
                    <Label htmlFor={`ticket-max-${ticket.id}`}>
                  ...
                  <div className='flex items-center space-x-2'>
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateTicket(ticket.id, 'hideWhenUnavailable', checked)
                      }
                    />
                    <Label htmlFor={`ticket-hide-${ticket.id}`}>
                      Hide when sold out
                    </Label>
                  </div>
                </div>
